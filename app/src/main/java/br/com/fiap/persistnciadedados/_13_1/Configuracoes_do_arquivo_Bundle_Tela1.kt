 ...
 */
class Configuracoes_do_arquivo_Bundle_Tela1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.configuracoes_do_arquivo_bundle_tela1)
    ...
    fun usarBundle(view: View) {
        ...
        val intent = Intent(this, Configuracoes_do_arquivo_Bundle_Tela2::class.java)
